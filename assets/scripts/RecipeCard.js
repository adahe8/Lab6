...
class RecipeCard extends HTMLElement {
  ...
  constructor() {
    ...
    let shadowD = this.attachShadow({ mode: "open" });
    // A2. TODO - Create an <article> element - This will hold our markup once our data is set
    this.recipeRoot = document.createElement("article");
    // A3. TODO - Create a style element - This will hold all of the styles for the Web Component
    let recipeStyles = document.createElement("style");
    ...
    shadowD.append(this.recipeRoot);
    shadowD.append(recipeStyles);
  }
  ...
  set data(data) {
    ...
    let getArticle = this.recipeRoot;
